...
async function createFallbackFrame(parentFrame: FrameNode, modelKey: iPhoneModelKey, model: iPhoneModel): Promise<void> {
  // Create outer frame
...
function getCornerRadius(modelKey: iPhoneModelKey): number {
  const cornerRadii: Record<iPhoneModelKey, number> = {
    'iphone-se': 20,
    'iphone-14': 47,
    'iphone-14-pro': 55
  };
...
function getScreenCornerRadius(modelKey: iPhoneModelKey): number {
  const screenCornerRadii: Record<iPhoneModelKey, number> = {
    'iphone-se': 5,
    'iphone-14': 27,
    'iphone-14-pro': 35
  };
...
async function addDynamicIsland(parentFrame: FrameNode, model: iPhoneModel): Promise<void> {
...
async function addNotch(parentFrame: FrameNode, model: iPhoneModel): Promise<void> {
...
async function addHomeButton(parentFrame: FrameNode, model: iPhoneModel): Promise<void> {
